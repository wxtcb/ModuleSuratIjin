...
<body>
    ...
    <div class="page-wrapper">
        ...
        <table class="form">
            ...
            <tr>
                <td>NIP / NIK</td>
                <td>: {{ $terlambat->pegawai->nip }}</td>
            </tr>
            <tr>
                <td>Pangkat / Gol.</td>
                <td>: {{ $terlambat->pegawai->id_staff }}</td>
            </tr>
            <tr>
                <td>Jabatan</td>
                <td>: {{ $terlambat->pegawai->id_staff }}</td>
            ...
            <tr>
                <td>Unit Kerja</td>
                <td>: {{ $terlambat->timKerja->unit->nama}}</td>
            </tr>
        </table>
        ...
        <div class="container">
            ...
            <div class="signatures">
                <div class="ttd">
                    <div class="sign">
                        Banyuwangi, {{ date('d M Y', strtotime($terlambat->created_at)) }}<br>
                        Hormat Saya,<br>
                        <div class="digital-stamp">
                            <div class="stamp-logo">
                                <img src="{{ asset('assets/img/logo.png') }}" alt="Logo Instansi">
                        ...
                        {{ $terlambat->pegawai->gelar_dpn ?? '' }}{{ $terlambat->pegawai->gelar_dpn ? ' ' : '' }}{{ $terlambat->pegawai->nama }}{{ $terlambat->pegawai->gelar_blk ? ', ' . $terlambat->pegawai->gelar_blk : '' }}<br>
                        NIP/NIPPPK/NIK. {{$terlambat->pegawai->nip}}
                    </div>
