        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('lupa.update', $lupa->access_token) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row mb-2">
                            <div class="col-md-4">
                                ...
                                <select name="jenis_ijin" id="jenis_ijin" class="form-control" required>
                                    ...
                                    <option value="Lupa Absen Masuk" {{ $lupa->jenis_ijin === 'Lupa Absen Masuk' ? 'selected' : '' }}>Lupa Absen Masuk</option>
                                    <option value="Lupa Absen Pulang" {{ $lupa->jenis_ijin === 'Lupa Absen Pulang' ? 'selected' : '' }}>Lupa Absen Pulang</option>
                                </select>
                            </div>
                            <div class="col-md-4">
                                <label for="hari" class="form-label">Hari</label>
                                <input type="text" name="hari" id="hari" class="form-control" value="{{ $lupa->hari }}" required>
                            </div>
                            <div class="col-md-4">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="alasan" id="alasan" class="form-control" rows="3" required>{{ $lupa->alasan }}</textarea>
                        </div>
